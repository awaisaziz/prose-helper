...
import { LEADS, Lead } from "@/lib/prose-data";
      ...
      <div className="flex items-end justify-between">
        <div>
          <div className="text-[11px] uppercase tracking-[0.18em] text-ink-faint">
            Synced with prosehelper.ca · last poll 14s ago
          </div>
          ...
          <p className="mt-3 max-w-xl text-[14px] text-ink-soft">
            Every inbound lead, scored for fit and margin. Approve once, and proseOS handles the engagement sequence.
          </p>
        </div>
