...
import { MATTERS } from "@/lib/dictum-data";
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-3xl border border-hairline bg-canvas p-10">
          ...
          <div className="mt-8 rounded-2xl bg-fog p-6 text-[13px] text-ink-soft">
            Detailed file view for this matter is queued for the next dictumOS release.
          ...
          <div className="rounded-3xl border border-hairline bg-canvas p-7">
            ...
            <ol className="relative mt-5 pl-1">
              ...
              {[
                ...
                { state: "progress", date: "Jul 16 · 11:30", title: "Demand letter drafted by dictumOS", sub: "Awaiting attorney signature", note: "Assembled from 4 PackCo precedents · est. 6h saved" },
